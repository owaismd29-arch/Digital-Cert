[![Java CI with Maven in Linux](https://github.com/owaismd29-arch/Digital-Cert/actions/workflows/maven.yml/badge.svg?branch=master)](https://github.com/owaismd29-arch/Digital-Cert/actions/workflows/maven.yml?query=branch%3Amaster)
